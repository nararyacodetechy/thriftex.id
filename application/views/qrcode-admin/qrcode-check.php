        ...
        <div class="card mb-2 pb-4 min-h-1vh">
            <div class="content mb-2">
                <div class="d-flex justify-content-between align-items-center mt-3 mb-4">
                    <h3>Data Request QR Code</h3>
                </div>
                <div class="search-box search-header bg-theme card-style me-0 ms-0 mb-2">
                    <i class="fa fa-search"></i>
                    <input type="text" class="border-0 searchInput" placeholder="Cari nama brand... ">
                    <a href="#" class="clear-search disabled mt-0"><i class="fa fa-times color-red-dark"></i></a>
                </div>
                <div class="tab-controls tabs-small tabs-rounded" data-highlight="bg-highlight">
                    <a href="#new" data-active data-bs-toggle="collapse" data-bs-target="#tab-1">Request Baru</a>
                    <!-- <a href="#rejected" data-bs-toggle="collapse" data-bs-target="#tab-2">Ditolak</a> -->
                </div>
                ...
                <input type="hidden" id="list_url" value="<?= base_url('qrcode-list-new') ?>" name="">
                <div style="display: none;" id="table_column">[{"data":"data_qrcode"},{"data":"status_bayar"}]</div>
                <div style="display: none;" id="table_columnDef">[{"className":"p-3","targets":[0]},{"className":"text-end","targets":[1]}]</div>
                <div style="display: none;" data-style="dropdown" id="table_action">{"terimaQrcode":true,"tolakQrcode":true}</div>
                ...
                <table class="table table-hover rounded-s shadow-l datatable" style="overflow: hidden;" table-jx id="datatable">
                    <thead>
                        <tr class="bg-night-light sata">
                            <th scope="col" class="color-white p-3">Data</th>
                            <th scope="col" class="color-white p-3">Status</th>
