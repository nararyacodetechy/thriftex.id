    ...
    <div class="col col-lg-4 ms-0 me-0 ps-0 pe-0">
        <div class="card mb-2 pb-4 min-h-1vh">
            <div class="content mb-2">
                ...
                <div class="d-flex justify-content-between d-none">
                    <div class="">
                        <select class="niceSelect wide">
                            <option data-display="Filter By Toko" selected>Filter By Toko</option>
                ...
                <div style="display: none;" id="table_column">[{"data":"data_nama"},{"data":"status"}]</div>
